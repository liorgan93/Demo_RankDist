...
# If preference data is incomplete, restart the process
...
# Display the user_classification page
def user_classification_page():
    ...
    if current_index < len(st.session_state.songs_df):
        ...
        # If preference data is incomplete, show problem message to the user
        problem_msg = """
        ...
        # Move to next song and count it as like
        def handle_like():
        ...
        # Move to next song and count it as dislike
        def handle_dislike():
            if not st.session_state.button_clicked:
                st.session_state.button_clicked = True
