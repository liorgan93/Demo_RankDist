...
def perfect_precision_compare_recommendations_page():
    ...
    st.markdown('<div style="text-align:center; margin-top:-28px; font-size:14px; font-weight: bold; font-family: Georgia, serif;">Your picks vs. the RankDist algorithm</div>', unsafe_allow_html=True)
