...
# Calculate score comparing user/algorithm recommendations to the correct songs
...
# Display the perfect_precision_compare_recommendations page
def perfect_precision_compare_recommendations_page():
    ...
    # Show comparison table and scores for the user and the RankDist algorithm
    ...
    # Display the message showing the winner (user, RankDist, or tie)
