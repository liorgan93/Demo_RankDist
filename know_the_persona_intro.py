...
def know_the_persona_intro_page():
    ...
    st.markdown(f"""
        <div class="container">
            ...
            <div class="sub-header">Listen to <strong style="font-weight: bold; text-shadow: 0 0 1px rgba(255,255,255,0.3);"> {persona_name}'s favorite songs </strong> and mark the ones you know. Knowing {gender_possessive} musical taste will help you recommend songs to {gender_pronoun}</div>
            <div> 
