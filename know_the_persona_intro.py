...
def know_the_persona_intro_page():
    ...
    st.markdown(f"""
        <div class="container">
            ...
            <div class="sub-header">Listen to <strong style="font-weight: 900;"> {persona_name}'s favorite songs </strong> and mark the ones you know. Knowing {gender_possessive} musical taste will help you recommend songs to {gender_pronoun}</div>
            <div> 
