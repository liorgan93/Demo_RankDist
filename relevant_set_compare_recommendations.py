...
def relevant_set_compare_recommendations_page():
    ...
    st.markdown(f"<div style='text-align:center; font-size:16px; margin-top:3px;'>🧍 <b>Your Score:</b> {user_score} &nbsp;&nbsp;&nbsp; 🤖 <b>RankDist Score:</b> {alg_score}</div>", unsafe_allow_html=True)
