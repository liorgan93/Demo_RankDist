...
def relevant_set_compare_recommendations_page():
    ...
    st.markdown('<div style="text-align:center; margin-top:-28px; margin-bottom:-50px; font-size:15px; font-weight: bold; font-family: Segoe UI, sans-serif;">Your picks VS the RankDist algorithm</div>', unsafe_allow_html=True)
